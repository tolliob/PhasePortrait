...
class PhasePortraitGUI:
    ...
    def __init__(self, fct, fct_name):
        ...
        left_lower = RiemannSphereWidget("Left lower corner:", -20, 20, step=1, value=RiemannSphere(-2, -2))
        right_upper = RiemannSphereWidget("Right upper corner:", -20, 20, step=1, value=RiemannSphere(2, 2))

        ## drawing precision
        text_precision = widgets.HTML(value='<b>Number of pixels per unit:</b>')
        precision_slider = widgets.IntSlider(value=50, min=1, max=500.0, step=1)
